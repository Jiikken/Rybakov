...
class CommandsInChat(ChatModel, StatisticsModel, AdminsModel, PostsModel):
    ...
    - /i -- Статистика редакторов за выбранный промежуток дней или со дня сброса статистики
    - /ai -- Подробная статистика редакторов за промежуток дней со дня сброса статистики
    - /addmin -- Добавление пользователя в списки администраторов
    - /deladm -- Удаление пользователя из списков администрации
